...
class ProductService {
    ...
    public ResponseEntity<GetProductResponse> addProduct(@PathVariable final Long productId) {
    ...
    public ResponseEntity<GetProductResponse> getProduct(long productId) {
        final Product product = productPort.getProduct(productId);
